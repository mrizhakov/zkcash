...
class EdTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        x = EDLight2DConv(kernel_size=4, kernel_output_size=4, channels=1, activation=tfb.layers.HardSigmoid())(inputs)
    ...
    def test_ED(self) -> None:
        test_model(self, './compiled_ed_hsig', proving_backend=ProvingBackend.GROTH16())