...
class DWConvTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        x = tf.keras.layers.DepthwiseConv2D(
            kernel_size=4, use_bias=True, depth_multiplier=3,
    ...
    def test_Conv(self) -> None:
        #test_model(self, './compiled_dwconv', proving_backend=ProvingBackend.GROTH16())
        test_model(self, './compiled_dwconv_ug', proving_backend=ProvingBackend.ULTRAGROTH())