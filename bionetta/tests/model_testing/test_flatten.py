"""
Test of Flatten layer. It works as follows:
...
class FlattenTest(unittest.TestCase):
    """
    Class for testing Flatten Layer of the Bionetta framework
    with a simple MNIST model.
    """
    
    MODEL_NAME = 'flatten_model'
    ...
    def setUp(self) -> None:
        ...
        self.proving_backend = ProvingBackend.ULTRAGROTH()
        ...
        x = tf.keras.layers.Flatten(input_shape=(28,28,1))(inputs)
        print(x.shape)
    ...
    def test_Flatten(self) -> None:
        test_model(self, './compiled_flatten_ug', self.proving_backend)
