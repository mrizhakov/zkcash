...
class HardSigmoid(BionettaLayer, HardSigmoid):
    """
    Class implementing the Hard Sigmoid activation function, given by:
    ...
    def build(self, input_shape: tf.TensorShape) -> None:
        ...
        For HardSigmoid, this function simply computes the number of constraints
        """
    ...
    def calculate_constraints(
        ...
        return LayerComplexity(
            mul_ops=0,
            non_linear_ops=[
                (ActivationOps.HARD_SIGMOID, input_neurons)
            ],
        )
